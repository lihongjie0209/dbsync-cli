...
/**
 * End-to-end integration test: PostgreSQL 16 → PostgreSQL 16.
 * Exercises the pgoutput logical replication slot pipeline.
 */
@Testcontainers
@TestInstance(TestInstance.Lifecycle.PER_CLASS)
@DisplayName("PostgreSQL 16 → PostgreSQL 16")
class PgToPgSyncIT extends AbstractSyncIT {
    ...
    void fullSyncCycle() throws Exception {
        Path workDir = Files.createTempDirectory("dbsync-pg2pg-");
